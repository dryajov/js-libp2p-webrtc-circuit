...
describe('filter', () => {
  it('filters non valid webrtc-direct multiaddrs', () => {
    ...
    const maArr = [
      multiaddr('/ip4/1.2.3.4/tcp/3456/http/p2p-webrtc-circuit'),
      multiaddr('/ip4/127.0.0.1/tcp/9090/ws'),
      multiaddr('/ip4/127.0.0.1/tcp/9090/ws/p2p-webrtc-circuit/ipfs/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo2'),
